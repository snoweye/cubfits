...
fn.out <- paste(prefix$plot.nps.match, "corr_logmu_pm_nps.pdf", sep = "")
...
fn.out <- paste(prefix$plot.nps.match, "corr_logmu_scuo_nps.pdf", sep = "")
pdf(fn.out, width = 5, height = 5)
...
fn.out <- paste(prefix$plot.nps.match, "corr_deltat_pm_nps.pdf", sep = "")
pdf(fn.out, width = 5, height = 5)
  plot.b.corr(x.pm, y.pm, x.pm.label,
              x.ci = x.pm.ci, y.ci = y.pm.ci,
              xlim = xlim, ylim = ylim,
...
fn.out <- paste(prefix$plot.nps.match, "corr_deltat_scuo_nps.pdf", sep = "")
pdf(fn.out, width = 5, height = 5)
  plot.b.corr(x.scuo, y.scuo, x.scuo.label,
              x.ci = x.scuo.ci, y.ci = y.scuo.ci,
              xlim = xlim, ylim = ylim,
...
fn.out <- paste(prefix$plot.nps.match, "corr_nonscale_deltat_pm_nps.pdf", sep = "")
pdf(fn.out, width = 5, height = 5)
  plot.b.corr(x.pm, y.pm, x.pm.label,
              x.ci = x.pm.ci, y.ci = y.pm.ci,
              xlim = xlim, ylim = ylim,
...
fn.out <- paste(prefix$plot.nps.match, "corr_nonscale_deltat_scuo_nps.pdf", sep = "")
pdf(fn.out, width = 5, height = 5)
  plot.b.corr(x.scuo, y.scuo, x.scuo.label,
              x.ci = x.scuo.ci, y.ci = y.scuo.ci,
              xlim = xlim, ylim = ylim,
