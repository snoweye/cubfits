...
### Plot posterior mean.
fn.out <- paste(prefix$plot.nps.match, "prxy_wci_pm_nps.pdf", sep = "")
...
fn.out <- paste(prefix$plot.nps.match, "prxy_wci_scuo_nps.pdf", sep = "")
pdf(fn.out, width = 5, height = 5)
  ### x-axis: with phi, y-axis: without phi.
...
fn.out <- paste(prefix$plot.nps.match, "prxy_wci_med_pm_nps.pdf", sep = "")
pdf(fn.out, width = 5, height = 5)
  ### x-axis: with phi, y-axis: without phi.
...
fn.out <- paste(prefix$plot.nps.match, "prxy_wci_med_scuo_nps.pdf", sep = "")
pdf(fn.out, width = 5, height = 5)
  ### x-axis: with phi, y-axis: without phi.
