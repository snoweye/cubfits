...
for(i.case in c(2, 3)){
  ...
  ### log.mu
  b.logmu[[case.names[i.case]]] <- b.logmu.PM
  b.logmu.ci[[case.names[i.case]]] <- b.logmu.ci.PM
  b.logmu.label.list[[case.names[i.case]]] <- b.logmu.label
...
### Set layout.
fn.out <- paste(prefix$plot.nps.multi, case.main, "_nps.pdf", sep = "")
