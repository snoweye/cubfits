...
### Plot posterior mean.
fn.out <- paste(prefix$plot.nps.match, "prxy_pm_nps.pdf", sep = "")
...
fn.out <- paste(prefix$plot.nps.match, "prxy_scuo_nps.pdf", sep = "")
pdf(fn.out, width = 5, height = 5)
  ### x-axis: with phi, y-axis: without phi.
...
fn.out <- paste(prefix$plot.nps.match, "prxy_med_pm_nps.pdf", sep = "")
pdf(fn.out, width = 5, height = 5)
  ### x-axis: with phi, y-axis: without phi.
...
fn.out <- paste(prefix$plot.nps.match, "prxy_med_scuo_nps.pdf", sep = "")
pdf(fn.out, width = 5, height = 5)
  ### x-axis: with phi, y-axis: without phi.
