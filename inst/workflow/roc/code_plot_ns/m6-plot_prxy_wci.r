...
# Plot posterior mean.
fn.out <- paste(prefix$plot.ns.match, "prxy_wci_pm.pdf", sep = "")
...
fn.out <- paste(prefix$plot.ns.match, "prxy_wci_scuo.pdf", sep = "")
pdf(fn.out, width = 5, height = 5)
  # x-axis: with phi, y-axis: without phi.
...
fn.out <- paste(prefix$plot.ns.match, "prxy_wci_med_pm.pdf", sep = "")
pdf(fn.out, width = 5, height = 5)
  # x-axis: with phi, y-axis: without phi.
...
fn.out <- paste(prefix$plot.ns.match, "prxy_wci_med_scuo.pdf", sep = "")
pdf(fn.out, width = 5, height = 5)
  # x-axis: with phi, y-axis: without phi.
