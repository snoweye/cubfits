...
\label{sec:multinom}
\addcontentsline{toc}{subsection}{\thesection.\thesubsection Multinomial Logistic Regression}
...
\label{sec:asl}
\addcontentsline{toc}{subsection}{\thesection. Asymmetric Laplace Distribution}
