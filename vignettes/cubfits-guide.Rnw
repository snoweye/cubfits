...
\documentclass[article,shortnames,nojss]{cubfits-include/jss}

\newcommand{\pkgver}{0.1-0}
...
\begin{minipage}{6in}
\centering
Wei-Chen Chen$^1$, Russell Zaretzki$^2$, William Howell$^1$, \\
Drew Schmidt$^3$, and Michael Gilchrist$^{1,4}$
\end{minipage}
\\
\\
...
\Plainauthor{Chen, W.-C., Zaretzki, R., Howell, W., Schmidt, D., Gilchrist, M.} %% comma-separated
